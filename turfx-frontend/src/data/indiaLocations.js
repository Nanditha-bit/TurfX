// India location data: States/UTs with their FULL list of districts
// Used by the Navbar location selector (Country -> State -> District)
// Counts reflect current district reorganizations as of the latest known notifications.
...
export const INDIA_STATES = {
  ...
  'Madhya Pradesh': [ // 55 districts
    ...
    'Khargone', 'Maihar', 'Mandla', 'Mandsaur',
    'Morena', 'Nagda', 'Narmadapuram', 'Narsinghpur', 'Neemuch',
    'Niwari', 'Panna', 'Pandhurna', 'Raisen', 'Rajgarh',
  ...
  'Punjab': [ // 23 districts
    ...
    'Sri Muktsar Sahib', 'Pathankot', 'Patiala', 'Rupnagar', 'SAS Nagar (Mohali)',
  ...
  'Ladakh': ['Kargil', 'Leh'], // 2 districts
  'Lakshadweep': ['Lakshadweep'], // single administrative district
